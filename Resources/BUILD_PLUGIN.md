...
1. **Searches for Unreal Engine 5.8** in common installation locations
...
2. **Wrong UE version** - The script looks for UE 5.8 by default
...
For manual Mac builds (supported in this fork), use:
```bash
